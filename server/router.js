...
const router = (app) => {
  ...
  // dog gets
  app.get('/ageDog', controllers.ageDogByName);

  // catch for any other GET request. The * means anything
  // this must go AFTER all the other GET handlers, otherwise it will override them
  ...
  // dog posts
  app.post('/uploadDog', controllers.createDog);
};
